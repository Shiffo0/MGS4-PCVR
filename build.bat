...
cl /nologo /W3 /O2 /DDG_ENABLE_DIAGNOSTICS=0 /I "%OPENXR_INCLUDE%" /Fo"build\\" /LD src\mgs4vr.c src\mgs4vr_gfx.c src\mgs4vr_cam.c src\mgs4vr_xr.c src\mgs4vr_head.c src\mgs4vr_menu.c src\mgs4vr_log.c src\mgs4vr_render.c src\mgs4vr_eye.c src\mgs4vr_packet.c src\mgs4vr_stereo.c src\mgs4vr_uniform.c src\mgs4vr_scan.c /link /OUT:build\mgs4vr.asi /IMPLIB:build\mgs4vr.lib dxguid.lib user32.lib gdi32.lib bcrypt.lib
set "rc=%ERRORLEVEL%"
popd
exit /b %rc%
